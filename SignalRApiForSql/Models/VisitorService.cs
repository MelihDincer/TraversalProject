...
namespace SignalRApiForSql.Models
{
    public class VisitorService
    {
        ...
        public VisitorService(Context appContext, IHubContext<VisitorHub> hubContext)
        {
        ...
        public async Task SaveVisitor(Visitor visitor)
        {
            ...
            await _hubContext.Clients.All.SendAsync("ReceiveVisitorList", GetVisitorChartList());    //SignalR'da çağrılacak olan metotlar SendAsync metoduyla çağrılır.
        }
