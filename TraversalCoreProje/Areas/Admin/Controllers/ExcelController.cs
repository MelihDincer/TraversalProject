...
namespace TraversalCoreProje.Areas.Admin.Controllers
{
    ...
    public class ExcelController : Controller
    {
        ...
        public IActionResult StaticExcelReport() //Statik Excel Raporumuz
        {
        ...
        public IActionResult DestinationExcelReport() //Dinamik şekilde çalışan Destination Excel Raporumuz
        {
